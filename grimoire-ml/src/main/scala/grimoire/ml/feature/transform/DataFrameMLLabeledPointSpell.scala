...
/**
  ...
  */
private[grimoire] class DataFrameMLLabeledPointSpell
...
object DataFrameMLLabeledPointSpell{
  def apply(json: JsValue): DataFrameMLLabeledPointSpell = new DataFrameMLLabeledPointSpell().parseJson(json)
}